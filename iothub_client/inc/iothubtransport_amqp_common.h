...
MOCKABLE_FUNCTION(, void, IoTHubTransport_AMQP_Common_DeviceMethod_Response, IOTHUB_DEVICE_HANDLE, handle, METHOD_ID_HANDLE, methodId, const unsigned char*, response, size_t resp_size, int, status_response);
