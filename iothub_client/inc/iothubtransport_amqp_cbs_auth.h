...
extern "C"
{
	...
	typedef void(*ON_AUTHENTICATION_STATE_CHANGED_CALLBACK)(const void* context, AUTHENTICATION_STATE previous_state, AUTHENTICATION_STATE new_state);
	typedef void(*ON_AUTHENTICATION_ERROR_CALLBACK)(const void* context, AUTHENTICATION_ERROR_CODE error_code);
