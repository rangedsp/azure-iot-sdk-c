...
#define DEVICE_TWIN_UPDATE_STATE_VALUES \
    ...
    */
     ...
     * @return	IOTHUB_CLIENT_OK upon success or an error code upon failure.
     */
     MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_LL_DeviceMethodResponse, IOTHUB_CLIENT_LL_HANDLE, iotHubClientHandle, METHOD_ID_HANDLE, methodId, const unsigned char*, response, size_t, respSize, int, statusCode);
