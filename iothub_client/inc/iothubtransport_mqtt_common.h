...
MOCKABLE_FUNCTION(, void, IoTHubTransport_MQTT_Common_DeviceMethod_Response, IOTHUB_DEVICE_HANDLE, handle, uint16_t, methodId, const unsigned char*, response, size_t, resp_size, int, status_response);
